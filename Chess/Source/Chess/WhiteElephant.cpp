...
bool AWhiteElephant::LineTrace(FVector Direction)
{	
...
void AWhiteElephant::AttackKing()
{
	TArray<AActor*> Kings;
...
void AWhiteElephant::MoveUnderAttack()
{
	if (!IsDead)
	{
...
void AWhiteElephant::move(FVector Direction)
{	
...
void AWhiteElephant::ShowLocations()
{
	TArray<AActor*> FoundActors;
	UGameplayStatics::GetAllActorsOfClass(GetWorld(), AOnePeaceOfBoard::StaticClass(), FoundActors);
...
void AWhiteElephant::TurnOffLocations()
{
	TArray<AActor*> FoundActors;
	UGameplayStatics::GetAllActorsOfClass(GetWorld(), AOnePeaceOfBoard::StaticClass(), FoundActors);
...
bool AWhiteElephant::CanAttack(FVector Direction)
{	
...
void AWhiteElephant::Attack(ABlackChessFigure* BlackFigure)
{
...
bool AWhiteElephant::CanMove(FVector Direction)
{
...
bool AWhiteElephant::WillOpenChack()
{	
	WhiteKing->IsUnderAttack = false;
	WhiteKing->PossibleAttackDirections.Empty();
